...
class Usuario extends ActiveRecord
{
    ...
    public function validarNuevaCuenta(){
        ...
        if (!$this->password) {
            self::$alertas['error'][] = "El Password es Obligatorio o es Incorrecto ";
        }
    ...
    public function validarPassword(){
        ...
        if (strlen( $this->password)<7) {
            self::$alertas['error'][] = "El Password debe tener almenos 7 caracteres ";
        }
   ...
   public function comprobarPasswordAndVerificado($password){
    $resultado=password_verify($password,$this->password); //devuelve verdadero o falso
